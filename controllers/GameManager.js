...
export class GameManager {
    constructor() {
        this.pokemons = [
            new Pokemon({ name: 'Charmander', type: ["FIRE"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "I" }),
            new Pokemon({ name: 'Squirtle', type: ["WATER"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "II" }),
            new Pokemon({ name: 'Pikachu', type: ["ELECTRIC"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "III" }),
            new Pokemon({ name: 'Jigglypuff', type: ["NORMAL"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "IV" }),
            new Pokemon({ name: 'Meowth', type: ["NORMAL"], imgPath: "https://i.imgur.com/B0JXocb.jpg", gen: "I" }),
            new Pokemon({ name: 'Psyduck', type: ["WATER"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "VI" }),
            new Pokemon({ name: 'Geodude', type: ["ROCK", "GROUND"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "VII" }),
            new Pokemon({ name: 'Machop', type: ["FIGHTING"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "VIII" }),
            new Pokemon({ name: 'Gastly', type: ["GHOST", "POISON"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "IX" }),
            new Pokemon({ name: 'Eevee', type: ["NORMAL"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "I" }),
            new Pokemon({ name: 'Snorlax', type: ["NORMAL"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "II" }),
            new Pokemon({ name: 'Vulpix', type: ["FIRE"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "III" }),
            new Pokemon({ name: 'Kabuto', type: ["ROCK", "WATER"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "IV" }),
            new Pokemon({ name: 'Dratini', type: ["DRAGON"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "V" }),
            new Pokemon({ name: 'Mareep', type: ["ELECTRIC"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "VI" }),
            ...
            new Pokemon({ name: 'Treecko', type: ["GRASS"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "IX" }),
            new Pokemon({ name: 'Mudkip', type: ["WATER"], imgPath: "https://i.imgur.com/FaX9GeQ.jpg", gen: "I" }),
