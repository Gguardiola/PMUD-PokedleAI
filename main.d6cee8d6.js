...
var GameView = exports.GameView = /*#__PURE__*/function () {
  ...
  _createClass(GameView, [{
    ...
    value: function render(pokemon) {
      ...
      $("#buttons-col").append($('<button>').attr("data-bs-toggle", "modal").attr("data-bs-target", "#exampleModal").text('Hint').addClass("btn btn-outline-danger showHint "));
...
//# sourceMappingURL=main.d6cee8d6.js.map