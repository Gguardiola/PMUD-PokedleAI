...
var GameView = exports.GameView = /*#__PURE__*/function () {
  ...
  _createClass(GameView, [{
    ...
    value: function updateModal(pokemon, hintCounter) {
      ...
      switch (hintCounter) {
        case 1:
          $("#hint-text-modal").text("Hint: Pok\xE9mon's type(s): \"".concat(pokemon.type, "\"."));
          break;
        case 2:
          $("#hint-text-modal").text("Hint: Pok\xE9mon's generation is: \"".concat(pokemon.gen, "\"."));
          break;
        case 3:
...
//# sourceMappingURL=main.32751fec.js.map