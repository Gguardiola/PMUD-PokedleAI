...
var GameView = exports.GameView = /*#__PURE__*/function () {
  ...
  _createClass(GameView, [{
    ...
    value: function render(pokemon) {
      ...
      $("#feedback-col").append("<p>").text("Hints left: ".concat(MAX_HINTS));
    ...
    key: "updateHints",
    value: function updateHints(hintCounter) {
      $("#feedback-col").append("<p>").text("Hints left: ".concat(MAX_HINTS - hintCounter));
    }
  }, {
    key: "rerollGame",
    ...
    value: function updateModal(pokemon, hintCounter) {
      ...
      switch (hintCounter) {
        case 1:
          ...
          $("#hint-text-modal-body").text("".concat(pokemon.type.join('  ')));
          break;
        case 2:
          $("#hint-text-modal").append("<p>").text("The pokemon's generation is: ");
          $("#hint-text-modal").append("<br>");
          $("#hint-text-modal").append("<p>").text("".concat(pokemon.gen));
          break;
        case 3:
          $("#hint-text-modal").text("Hint: The Pok\xE9mon's name starts with the letter \"".concat(pokemon.name.charAt(0), "\"."));
          break;
        default:
          break;
      }
...
//# sourceMappingURL=main.f98392d3.js.map